...
public class DeliveryDetailResponseDto {
    ...
    private List<DeliveryRouteDetailResponseDto> deliveryRoutes;

    @Getter
    @Builder
    @AllArgsConstructor
    @NoArgsConstructor
    public static class DeliveryRouteDetailResponseDto {
    ...
    private List<OrderInfoResponseDto> orderItems;
}
